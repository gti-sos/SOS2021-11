    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(td, file$1, 6, 12, 70);
    			add_location(tr, file$1, 5, 8, 52);
    			attr_dev(table, "class", "svelte-15228qj");
    			add_location(table, file$1, 4, 4, 35);
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t4 = space();
    			p = element("p");
    			p.textContent = "This is my first svelte app";
    			t6 = space();
    			...
    			tr = element("tr");
    			td = element("td");
    			td.textContent = "My cell 2";
    			attr_dev(h1, "class", "svelte-1tky8bj");
    			add_location(h1, file, 6, 1, 93);
    			add_location(input, file, 7, 1, 118);
    			add_location(p, file, 8, 1, 146);
    			add_location(td, file, 13, 12, 242);
    			add_location(tr, file, 12, 8, 224);
    			add_location(table, file, 11, 1, 207);
